...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame_5.setStyleSheet(
            u"background-color: qconicalgradient(cx:0.5, cy:0.5, angle:90, stop:0.752 rgb(202, 202, 202) stop:0.755 "
            u"rgb(38, 43, 53));\n "
            "border-radius:75px;")
        ...
        self.weather.setStyleSheet(u"QPushButton {	\n"
                                   "	background-image:url(C:/Users/Admin/Desktop/YASH "
